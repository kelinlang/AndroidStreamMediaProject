...
GLuint StreamMedia::media::ShaderUtils::createProgram(const char *vertexSource,
...
GLuint StreamMedia::media::ShaderUtils::loadShader(GLenum shaderType, const char *source) {
